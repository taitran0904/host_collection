...
export const MY_PAGE_SETTINGS = lang === "en" ? "MY PAGE - SETTINGS" : "";
export const INFO_USER = lang === "en" ? "Info user" : "情報ユーザー";

export const SHOP_MANAGEMENT = lang === "en" ? "SHOP MANAGEMENT" : "";
export const ABOUT_NOMINATED = lang === "en" ? "ABOUT NOMINATED" : "";
export const LIST_FAVORITE = lang === "en" ? "LIST FAVORITE" : "";
export const HOST = lang === "en" ? "HOST" : "";
export const SHOP = lang === "en" ? "SHOP" : "";
export const TODAY_CHOOSE = lang === "en" ? "Today choose" : "";
export const REMOVE = lang === "en" ? "Remove" : "";
export const VIEW_MORE = lang === "en" ? "VIEW MORE" : "";
export const LIKE_THIS = lang === "en" ? "Like this" : "";
...
export const SNS_UPDATE = lang === "en" ? "SNS Update" : "";
export const FAVORITE_ANNIVERSARY = lang === "en" ? "Favorite Anniversary" : "";
export const VIBRATE = lang === "en" ? "Vibrate" : "";
export const SOUND = lang === "en" ? "Sound" : "";
...
export const ABOUT_NOMINATED_CONTENT =
  lang === "en"
    ...
    : "";
export const LIST_FAVORITE_CONTENT =
  lang === "en"
...
export const POS = lang === "en" ? "POS" : "";
export const CUSTOMER = lang === "en" ? "CUSTOMER" : "";
export const BIRTHDAY = lang === "en" ? "BIRTHDAY" : "";

export const HAVE_NOT_NAME = lang === "en" ? "You have not nick name" : "";
export const STATISTICAL = lang === "en" ? "STATISTICAL" : "";
export const PEOPLE_LIKE_THIS = lang === "en" ? "People(s) like this" : "";
...
export const TWITTER = lang === "en" ? "ID Twitter" : "ID Twitter";
export const INSTAGRAM = lang === "en" ? "ID Instagram" : "ID Instagram";

export const EDIT_PROFILE = lang === "en" ? "EDIT PROFILE" : "プロファイル編集";
export const FULL_NAME = lang === "en" ? "Full name" : "フルネーム";
export const DATE_OF_BIRTH = lang === "en" ? "Date of birth" : "生年月日";
...
export const LINE = lang === "en" ? "LINE" : "LINE";
export const ADDRESS = lang === "en" ? "Address" : "住所";
export const UPLOAD_PHOTO = lang === "en" ? "UPLOAD PHOTO" : "";
export const PHOTO_GALLERY = lang === "en" ? "PHOTO GALLERY" : "";
...
export const SEND_REQUEST = lang === "en" ? "SEND REQUEST" : "";
...
export const CRITERIA_OF_MONTH = lang === "en" ? "CRITERIA OF MONTH" : "";
export const ESTIMATED_SALARY_FOR_THIS_MONTH =
...
export const AQUARIUS = lang === "en" ? "Aquarius" : "Aquarius";
export const PISCES = lang === "en" ? "Pisces" : "Pisces";
export const ARIES = lang === "en" ? "Aries" : "Aries";
export const TAURUS = lang === "en" ? "Taurus" : "Taurus";
export const GEMINI = lang === "en" ? "Gemini" : "Gemini";
export const CANCER = lang === "en" ? "Cancer" : "Cancer";
export const LEO = lang === "en" ? "Leo" : "Leo";
export const VIRGO = lang === "en" ? "Virgo" : "Virgo";
export const LIBRA = lang === "en" ? "Libra" : "Libra";
export const SCORPIO = lang === "en" ? "Scorpio" : "Scorpio";
export const SAGITTARIUS = lang === "en" ? "Sagittarius" : "Sagittarius";
export const CAPRICORN = lang === "en" ? "Capricorn" : "Capricorn";

export const LEAVE_FORM_MESSAGE =
  lang === "en"
    ? "The changed information has not been saved yet, are you sure you want to leave?"
    : "";
export const LEAVE_WITHDRAWAL_MESSAGE =
  lang === "en"
...
export const ARE_YOU_SURE_DELETE_THIS_FAVORITE =
  lang === "en"
    ? "Are you sure delete this favorite?"
    : "このお気に入りを削除してもよろしいですか？";
export const YES_DELETE = lang === "en" ? "Yes, Delete it" : "";
export const NO = lang === "en" ? "No" : "";

export const LINKAGE_SHOP = lang === "en" ? "LINKAGE SHOP" : "";
export const PHONE = lang === "en" ? "Phone" : "電話番号";
export const CHAMPAGNE_CALL = lang === "en" ? "Champagne Call" : "";
export const VR = lang === "en" ? "VR" : "";
export const LIVE = lang === "en" ? "LIVE" : "";

export const LATEST_POSTS = lang === "en" ? "LATEST POSTS" : "";
export const NUMBER_OF_DONATE = lang === "en" ? "DONATED" : "";
...
export const USING = lang === "en" ? "USING" : "";
export const REJECTED = lang === "en" ? "REJECTED" : "";
export const NEED_MORE_INFO = lang === "en" ? "NEED MORE INFO" : "";
export const MANAGER_LIST = lang === "en" ? "MANAGER LIST" : "";
export const CREATE_NEW_MANAGER = lang === "en" ? "CREATE NEW MANAGER" : "";
export const INFORMATION_MANAGER = lang === "en" ? "INFORMATION MANAGER" : "";
export const PHOTO_MANAGER = lang === "en" ? "PHOTO MANAGER" : "";
export const SELECT_MEMBER = lang === "en" ? "Select member" : "";
export const SELECT_SHOP = lang === "en" ? "Select shop" : "";
export const SHOP_NAME = lang === "en" ? "Shop name" : "";
export const PARENT_AREA = lang === "en" ? "Parent Area" : "";
export const CHILD_AREA = lang === "en" ? "Child Area" : "";
export const UPLOAD_LICENSE = lang === "en" ? "UPLOAD LICENSE" : "";

export const STAFF = lang === "en" ? "STAFF" : "";
export const RECRUIT = lang === "en" ? "RECRUIT" : "";
export const COUPON = lang === "en" ? "COUPON" : "";
export const TOPICS = lang === "en" ? "TOPICS" : "";
export const INFORMATION = lang === "en" ? "INFORMATION" : "";
export const EVENT = lang === "en" ? "EVENT" : "";

export const NUMBER_OF_STAFFS = lang === "en" ? "NUMBER OF STAFFS" : "";
export const OPEN_TIME = lang === "en" ? "OPEN TIME" : "";
export const REGULAR_HOLIDAY = lang === "en" ? "REGULAR HOLIDAY TIME" : "";
export const SYSTEM = lang === "en" ? "SYSTEM" : "";
...
export const CONTENT = lang === "en" ? "Content" : "";
export const SEND_CONTACT = lang === "en" ? "SEND CONTACT" : "";
export const RESET_FORM = lang === "en" ? "RESET FORM" : "";

export const COUPON_DETAIL = lang === "en" ? "COUPON DETAIL" : "";
export const RECRUIT_DETAIL = lang === "en" ? "RECRUIT DETAIL" : "";

export const FILTER_BY_CONDITION = lang === "en" ? "FILTER BY CONDITION" : "";
export const FILTER = lang === "en" ? "FILTER" : "";
...
export const UPLOAD_LICENCE_MESSAGE =
  lang === "en"
    ? "Note*: Please upload full information of business license, identification..."
    : "";
export const FETCH_SHOP_LIST_FAILED_MESSAGE =
  lang === "en" ? "Get your shop list failed. Please try again!" : "";
export const UPDATE_SHOP_ITEM_FAILED_MESSAGE =
  lang === "en" ? "Update this shop failed. Please try again!" : "";
export const UPDATE_SHOP_ITEM_SUCCESS_MESSAGE =
  lang === "en" ? "Update this shop successfully!" : "";
export const CREATE_SHOP_ITEM_FAILED_MESSAGE =
  lang === "en" ? "Create shop failed. Please try again!" : "";
export const CREATE_SHOP_ITEM_SUCCESS_MESSAGE =
  lang === "en" ? "Create this shop successfully!" : "";
export const DELETE_SHOP_ITEM_FAILED_MESSAGE =
  lang === "en" ? "Delete shop failed. Please try again!" : "";
export const DELETE_SHOP_ITEM_SUCCESS_MESSAGE =
